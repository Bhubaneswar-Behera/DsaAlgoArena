...
public class KosarajusAlgorithm {
    ...
    // This function implements Kosaraju's algorithm to find strongly connected components (SCCs) in a directed graph.
    public static void kosarajuAlgo(ArrayList<Edge> graph[] , int V){
        ...
        for (int i = 0; i <V ; i++) {
            for (int j = 0; j < graph[i].size() ; j++) {
                ...
                // make the edge in the opposite direction
                // edge.destination(i) --> edge.source
